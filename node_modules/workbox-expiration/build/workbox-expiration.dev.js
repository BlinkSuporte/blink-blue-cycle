  ...
  */
  ...
  class CacheExpiration {
    ...
    constructor(cacheName, config = {}) {
      ...
      this._cacheName = cacheName;
      this._timestodel = new CacheTimestampsModel(cacheName);
    }
    /**
    ...
    async expireEntries() {
      ...
      const urlsExpired = await this._timestodel.expireEntries(minTimestamp, this._maxEntries); // Delete URLs from the cache
    ...
    async updateTimestamp(url) {
      ...
      await this._timestodel.setTimestamp(url, Date.now());
    }
    /**
    ...
    async isURLExpired(url) {
      ...
      const timestamp = await this._timestodel.getTimestamp(url);
    ...
    async delete() {
      ...
      // a cache expiration.
      this._rerunRequested = false;
      await this._timestodel.expireEntries(Infinity); // Expires all.
    }
